...
I composed the contract using a variety of OpenZeppelin Solidity library contracts; if you are not able to do the same, I recommend [Vittominacori's Github repo](https://github.com/vittominacori) and [Token Mint](https://tokenmint.io/create-erc20-token.html). I'll be publishing an easy to use [Github repository](https://github.com/pleasemarkdarkly/solidity-ts-template) so that you can create any type of token as well as the ability to launch an ICO.

Given the expense of executing smart contracts on Ethereum, I've created three tokens: 
* [0x1e6db27e80e43f20cbff89704be4ccd634a0211c8954ce9348e5da7d484f60f8](https://etherscan.io/token/0x7824773bffa00f2b20b2db3b5fcc22c3713542e9)
* [0x4ed4DDd7981e347b673f697DC821965A3EB64b9c](https://etherscan.io/token/0x4ed4ddd7981e347b673f697dc821965a3eb64b9c)
* [0xE7b75279244a83f6945C0D012c44d03CDd9f5dD4](https://etherscan.io/address/0xe7b75279244a83f6945c0d012c44d03cdd9f5dd4)

The following is the CompuGlobalHyperMegaCorp smart contract. This is a [smart contract syntax cheatsheet](https://topmonks.github.io/solidity_quick_ref/).
