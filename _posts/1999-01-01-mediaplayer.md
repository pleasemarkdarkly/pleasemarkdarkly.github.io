---
layout: post
title: Portable Media Player (aka mp3 players) 1998-2002 
categories: [source code]
tags: [digital audio]
---

<div style="text-align: center"><img src="{{ site.baseurl }}/images/hipzip.jpg" alt="Hipzip" style="width: 400px;"/></div>
...
In 1998, I wanted to play mp3 on a portable device. In technical terms, implementing the mp3 algorithm on an embedded system. At the time, the following were the norm: 

* mini-disc was a thing
* 1 MB was about $1
* 8MB, 16MB, 32MB, and 64MB were common memory formats
* embedded systems or embedded operating systems were not the norm
* Palm Pilots were the rage
* Microsoft had just launched PocketPC

The first 6 months to a year were full of failures. Processors were not powerful enough, storage was expensive, there was no business case. Nonetheless I built a fixed function player from a breadboard in 1998 the below products followed. The entire source code for embedded media players can be found [here](https://github.com/pleasemarkdarkly/adotcorporation). I was lucky enough to work with super smart engineers while I developed business cases and partners. 
